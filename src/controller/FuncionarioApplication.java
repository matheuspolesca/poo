...
public class FuncionarioApplication {
    ...
    public static void cadastroFuncionario(String cadProfissao) {
        ...
        try{
           ...
           if ("Administrador".equals(Main.getProfissao())) {
                ...
                while (opc <= 0 || opc > 3) {
                    Util.Notifica("Quantidade de turnos devem ser de 1 a 3 (Manhã, Tarde, Noite)");
                    System.out.println("\nQuantos turnos você trabalha? (MAX 3)");
                    opc = sc.nextInt();
                }
...
//    }
    ...
    private static Funcionario pesquisarFuncionario() {
    ...
    private static void alterarPlantao() {
        Scanner sc = new Scanner(System.in);
        ArrayList<Plantao> periodo = new ArrayList<>();
